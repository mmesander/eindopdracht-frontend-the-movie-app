            ...
            <div className="page-outer-container">
                ...
                <div className="home-inner-container">
                    ...
                    {Object.keys(movies).length > 0 && movies.slice(0, 5).map((movie) => {
                        return <MovieCard key={movie.id} title={movie.title} image={movie.poster_path} rating={movie.vote_average} id={movie.id} name={movie.name} tv={false}/>
                    })}
                </div>
                ...
                <div className="home-inner-container">
                    ...
                    {Object.keys(series).length > 0 && series.slice(0, 5).map((tv) => {
                        return <MovieCard key={tv.id} title={tv.name} image={tv.poster_path} rating={tv.vote_average} id={tv.id} tv={true}/>
                    })}
                </div>
            </div>
        </>
